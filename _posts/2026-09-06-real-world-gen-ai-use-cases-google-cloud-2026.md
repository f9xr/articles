...
youtube_id: "tu6TdSIn3Qo"
faq:
  - q: "How many real world gen AI use cases has Google Cloud published?"
    a: "As of the April 2026 update, Google Cloud's list includes 1,302 real-world gen AI use cases from organizations across eleven major industries. The list started with 101 entries when it was first published in April 2024 and has been expanded roughly twice a year since."
  - q: "What industries are covered in Google's gen AI use case list?"
    a: "The list covers eleven major industry groups, including automotive and logistics, business and professional services, financial services, healthcare and life sciences, manufacturing, media and entertainment, public sector, and retail, among others."
  - q: "Are these gen AI use cases only relevant to large enterprises?"
    a: "No. While many entries come from large global companies, a significant number are from small businesses, startups, and firms with fewer than fifty employees, covering practical use cases like customer support automation, marketing content generation, and internal knowledge search."
  - q: "What are the six types of AI agents mentioned in the report?"
    a: "Google Cloud organizes the use cases into six agent types: Customer agents, Employee agents, Creative agents, Code agents, Data agents, and Security agents, each representing a different functional area where AI is being applied."
  - q: "Can a small business realistically use the same AI tools mentioned in this list?"
    a: "Yes, in most cases. Many of the productivity gains described in the report come from AI features already built into everyday business software, like email, spreadsheets, and video conferencing tools, rather than custom built enterprise systems, making them accessible to smaller businesses as well."
---
...
<iframe width="100%" height="400" src="https://www.youtube.com/embed/tu6TdSIn3Qo?si=yVsytDTglI02iu72" title="How teams are applying generative AI in practice" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen loading="lazy"></iframe>
