...
*What to do:* Look for images that return 404, redirect, or fail to load. A broken image is a visible trust problem — it directly lowers your [website trust score](https://f9xr.org/articles/2026/08/15/how-to-increase-website-trust-score.html){:target="_blank" rel="noopener noreferrer"} — and a wasted crawl slot.
