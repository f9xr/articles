...
faq:
  - q: "What are the most important SEM metrics to track?"
    a: "The core metrics are impressions, clicks, click through rate, cost per click, conversion rate, Quality Score, impression share, cost per acquisition, and return on ad spend. Together they show whether your campaigns are being seen, clicked, converted, and ultimately profitable."
  - q: "What is a good Quality Score in Google Ads?"
    a: "The average account in 2026 runs a Quality Score of 5 to 7. Pushing into the 8 to 10 range meaningfully lowers your cost per click and improves ad position without requiring a higher bid, making it one of the highest leverage improvements available in any account."
  - q: "What is the difference between broad, phrase, and exact match keywords?"
    a: "Broad match shows your ad for a wide range of related searches, phrase match requires the keyword's meaning to appear in a consistent order with some flexibility, and exact match shows your ad only for searches closely matching the keyword's precise meaning and intent. Exact match typically delivers the highest conversion rates but the lowest reach."
  - q: "Why should I use negative keywords in my SEM campaigns?"
    a: "Negative keywords prevent your ad from showing for searches that clearly do not match buyer intent, competing terms, job seekers, or free alternatives. A well maintained negative keyword list reduces wasted spend and improves both CTR and conversion rate by removing low intent impressions."
  - q: "What is a good ROAS for a small business in 2026?"
    a: "Cross industry ROAS benchmarks sit around 200 percent to 400 percent, with strong e-commerce campaigns often reaching 400 percent to 600 percent. The right target depends heavily on your specific profit margins, so ROAS should always be evaluated alongside actual margin, not compared to a generic industry average alone."
---
...
Before any individual metric makes sense, it helps to understand the system generating them. Every time someone searches a term you're bidding on, Google runs a real time auction among every advertiser targeting that keyword. Your position in the results isn't determined by your bid amount alone, it's determined by [Ad Rank](https://support.google.com/google-ads/answer/6167130){:target="_blank" rel="noopener noreferrer"}, a combination of your maximum bid, your Quality Score, and the expected impact of your ad's format and extensions.
...
Google's 1 to 10 rating of how relevant your keyword, ad copy, and landing page are to a given search, built from three components: expected CTR, ad relevance, and landing page experience. You can check the score for any keyword directly in [Google's Ads interface](https://support.google.com/google-ads/answer/6167118){:target="_blank" rel="noopener noreferrer"}.
...
A [negative keyword](https://support.google.com/google-ads/answer/2453972){:target="_blank" rel="noopener noreferrer"} tells Google explicitly not to show your ad for searches containing that term, even if it would otherwise match your targeting. This is one of the highest leverage, most underused levers in any SEM account.
...
1. Review your search terms report weekly when a campaign is new, then monthly once it stabilizes, looking specifically for queries that triggered your ad but clearly don't match buyer intent.
2. Add irrelevant terms as [negative keywords](https://support.google.com/google-ads/answer/7102995){:target="_blank" rel="noopener noreferrer"} at the campaign or ad group level, depending on whether the term should be excluded everywhere or just from a specific group.
3. Watch for cannibalization between your own ad groups, where two groups are competing against each other for the same broad search, and use negative keywords to keep them separated.
4. Reassess your negative list whenever you launch a new product, service, or campaign, since assumptions from your old offering may no longer apply.
